...
class UtilsTestCase(unittestTestCase):
    ...
    def test_get_lists_for_chroma_upsert_new_id_one(self):
        ...
        meta_data_dict = {'source': '/home/gareth/Documents/Projects/MCQ_Generator/local_storage/user_7/HYBRID_101.pdf',
                          'page': 0}

        all_splits = [document_1.page_content, document_2.page_content, document_3.page_content]
        new_id = 1

        expected_id_list, expected_metadata_list = get_lists_for_chroma_upsert(
            all_splits=all_splits, new_id=new_id, metadata=meta_data_dict)
        ...
        for split in all_splits:
            ...
            actual_metadata_list.append(meta_data_dict)
            new_id += 1
